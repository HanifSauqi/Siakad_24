          ...
          >
            ...
            <tbody>
              <tr
                ...
                v-for="(dosen, index) in dataDosen"
                :key="dosen.id"
              >
                <th
                  scope="row"
  ...
  async created() {
    ...
    try {
      const response = await axios.get(
        ...
        config
      ); // Menggunakan URL API yang diberikan
      this.dataDosen = response.data.data; // Mengakses array 'data' dalam respons
    } catch (error) {
      console.error(error);
    }
  },
